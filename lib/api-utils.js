...
export function sortData(students, sortBy, sortOrder) {
...
export function  searchFilter(classes, search,arr) {
  return classes;
 
}

export function paginate(classes, page, limit) {
  return classes.slice((page - 1) * limit, page * limit);
}
